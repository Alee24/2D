...
export const workspaceCategories: WorkspaceCategory[] = [
  ...
  },
  {
    ...
    tagline: 'Secure Private Office Suites (Min 6-Month Term)',
    description: 'Enclosed, lockable private office suites for teams requiring total confidentiality and security (Minimum 6-month rental term).',
  ...
  },
  {
    ...
    description: 'Our meeting room comfortably seats up to 4 guests in a premium intimate setting, perfect for confidentiality and privacy.',
    longDescription: 'Designed for focused team syncs and client pitches. Our meeting room comfortably seats up to 4 guests in a premium intimate setting, perfect for confidentiality and privacy.',
    image: pinpoint17Img,
...
export const workspaceSolutions: WorkspaceSolution[] = [
  ...
  },
  {
    ...
    recommendation: 'Secure Private Office Suites.',
...
export const locations: LocationData[] = [
  {
    ...
    email: 'info@secondesk.ke',
    mapEmbedUrl: 'https://maps.google.com/maps?q=SECONDESK+Nyali+Executive+Hub+Mombasa&hl=en&z=17&iwloc=&output=embed',
    mapUrl: 'https://maps.app.goo.gl/UFtufu7ruA8tNk4v6',
    startingPrice: 'KES 17,000 / mo',
